...
\section{Welcome}
	...
	*m=*g,*g=0:g?*g=9^y:0;}_ L>N){*G=O _ s>1){_ h&&c-L<0)P L _!h)i=n,B=O,b=p;}N=L;}
	...
	LabVIEW usually greats you with a launcher, figure \ref{startup}. From here you may open your recent projects, start a fresh project, or open a virtual instrument, known as a VI.\\ %TODO
	\\
	...
	\\
	In the next few sections we will go over how to create a VI, what is meant by the block diagram and the interface diagram, %TODO What is it called again?
